                    ...
                    <div class="container">
                        <form action="{{ route('update-menu', ['id' => $menu->id]) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $menu->name }}" class="form-control" id="name" name="name" aria-describedby="Name" placeholder="Enter name">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="link" name="link" rows="3" placeholder="Enter link">{{ $menu->link }}</textarea>
                                @if ($errors->has('link'))
